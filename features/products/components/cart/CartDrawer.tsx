...
export function CartDrawer() {
  ...
  const isOpenModal = pathname === '/cart';
  ...
  return (
    <Drawer isOpen={isOpenModal} onClose={onClose}>
...
export const CartDetails = ({
  ...
  const { isLoading, items, totalItems, totalPrice } = cart || {};

  if (isLoading) return <CartSkeleton />;

  return (
    <div className={cn('h-full bg-background shadow-xl flex flex-col', isFromDrawer && 'border-l')}>
      {/* Header */}
